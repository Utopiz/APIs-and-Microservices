...
var createAndSavePerson = function(done) {
  var p = new Person({
    name: "Sophia Wang",
    age: 20,
    favoriteFoods : ["grapefruit", "green tea"],
...
// 'arrayOfPeople'.
var arrayOfPeople = [
  {name : "Amber", age : 20, favoriteFoods : ["BBQ", "apple"], hobbies : ["dancing"]},
  {name : "Sandy", age : 18, favoriteFoods : ["cake", "pear"], hobbies : ["choir"]},
  {name : "Zoe", age : 25, favoriteFoods : ["hotpot", "meat"], hobbies : ["videogame"]} 
]
